...
def _configure_stdio_for_unicode_logs():
    """Prevent Windows console encoding from crashing on teacher names."""
...
def export_teacher_schedules(excel_file_path, output_dir="teacher_schedules", lesson_type_filter='all'):
    """
